...
function tem_o_ciclone() {
    ...
    for (i = 0; i < dp.length; i++) {
        comp_fundo.push(faixa_eficiencias[i] / sum_comp_fundo);
    }
    ...
    for (i = 0; i < dp.length; i++) {
        comp_topo.push(faixa_ef_topo[i] / sum_comp_topo);
    }

    let an_gran_fundo = somar_composicoes(comp_fundo);
    let an_gran_topo = somar_composicoes(comp_topo);

    console.log(an_gran_fundo);
    console.log(an_gran_topo);
